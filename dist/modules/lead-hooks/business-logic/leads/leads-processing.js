...
const fields_processing_1 = require("../fields/fields-processing");
const company_processing_1 = require("../company/company.processing");
const contact_processing_1 = require("../contact/contact.processing");
const responsible_processing_1 = require("../responsible/responsible.processing");
...
let LeadsProcessing = LeadsProcessing_1 = class LeadsProcessing {
    constructor(logger, leadsRepository, fieldProcessing, companyProcessing, contactProcessing, responsibleProcessing, amoApi) {
        this.logger = logger;
        this.leadsRepository = leadsRepository;
        this.fieldProcessing = fieldProcessing;
        this.companyProcessing = companyProcessing;
        this.contactProcessing = contactProcessing;
        this.responsibleProcessing = responsibleProcessing;
        this.amoApi = amoApi;
    }
