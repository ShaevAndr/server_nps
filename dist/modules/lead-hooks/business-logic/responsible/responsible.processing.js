...
var ResponsibleProcessing_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ResponsibleProcessing = void 0;
...
let ResponsibleProcessing = ResponsibleProcessing_1 = class ResponsibleProcessing {
    ...
    async getResponsible(accountId, subdomain, responsibleId) {
        const loggerContext = `${ResponsibleProcessing_1.name}/${this.getResponsible.name}/${subdomain}`;
    ...
    async updateResponsible(responsible) {
        const loggerContext = `${ResponsibleProcessing_1.name}/${this.updateResponsible.name}`;
...
exports.ResponsibleProcessing = ResponsibleProcessing;
exports.ResponsibleProcessing = ResponsibleProcessing = ResponsibleProcessing_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [logger_service_1.Logger,
        responsible_repository_1.ResponsibleRepository,
        amo_api_service_1.AmoApiService])
], ResponsibleProcessing);
//# sourceMappingURL=responsible.processing.js.map