...
import { Account, AccountSchema } from 'modules/account/models/account.models';
...
async function refreshAccessToken(refreshToken: string, accountId: number, subdomain: string): Promise<string> {
    ...
    return axios.post<TokensResponse>(`https://${subdomain}.amocrm.ru/oauth2/access_token`, {
...
export function UseTokenAuthorization(maxRetries = 2) {
    return function (
        _target: object,
        _propertyKey: string,
