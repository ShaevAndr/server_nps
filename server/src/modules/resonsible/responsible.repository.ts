...
import { Responsible as ResponsibleEntity } from './entities/responsible.entities'
...
export class ResponsibleRepository {
    ...
    public async addOrUpdate(user: ResponsibleEntity): Promise<ResponsibleDocument> {
        try {
    ...
    public async getByUserId(accountId: number, userId: number): Promise<ResponsibleDocument> {
        try {
    ...
    public async deleteAllUsers(accountId: number,): Promise<void> {
        try {
