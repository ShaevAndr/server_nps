...
var FieldsServices_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.FieldsServices = void 0;
...
let FieldsServices = FieldsServices_1 = class FieldsServices {
    constructor(logger, customFieldsRepository) {
        this.logger = logger;
        this.customFieldsRepository = customFieldsRepository;
    }
    async convertCustomFields(accountId, custom_fields) {
        const loggerContext = `${FieldsServices_1.name}/${this.convertCustomFields.name}/${accountId}`;
    ...
    async updateOrCreate(field) {
        const loggerContext = `${FieldsServices_1.name}/${this.updateOrCreate.name}`;
    ...
    async getField(accountId, fieldId) {
        const loggerContext = `${FieldsServices_1.name}/${this.getField.name}/${accountId}`;
...
exports.FieldsServices = FieldsServices;
exports.FieldsServices = FieldsServices = FieldsServices_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [logger_service_1.Logger,
        custom_fields_repository_1.CustomFieldsRepository])
], FieldsServices);
//# sourceMappingURL=fields.services.js.map