...
let CompanyServices = CompanyServices_1 = class CompanyServices {
    ...
    async getCompany(accountId, companyId) {
        const loggerContext = `${CompanyServices_1.name}/${this.getCompany.name}`;
    ...
    async updateCompany(company) {
        const loggerContext = `${CompanyServices_1.name}/${this.updateCompany.name}`;
...
exports.CompanyServices = CompanyServices = CompanyServices_1 = __decorate([
