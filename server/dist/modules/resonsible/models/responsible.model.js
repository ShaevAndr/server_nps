...
exports.ResponsibleSchema = exports.Responsible = void 0;
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
let Responsible = class Responsible extends mongoose_2.Document {
};
exports.Responsible = Responsible;
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", Number)
], Responsible.prototype, "account_id", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", Number)
