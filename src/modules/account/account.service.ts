...
export class AccountService {
    ...
    async installWidget(installAccountDto: AccountInstallDto): Promise<Account> {
    ...
    async uninstallWidget(accountId: string): Promise<Account> {
    ...
    async getPaidStatus(accountId: string): Promise<PaidStatus> {
