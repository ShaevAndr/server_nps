...
export class ReportSettingsRepository {
    ...
    async getAllSettings(accountId: number, subdomain: string): Promise<ReportSettings[]> {
        try {
    ...
    async getSettingsByName(settingsInfo: GetSettingsDto): Promise<ReportSettings | null> {
        try {
    ...
    async updateSettingsByName(reportSettings: ReportSettingsDto): Promise<ReportSettings> {
        try {
    ...
    async deleteSettings(settingsInfo: DeleteReportSettingsDto): Promise<void> {
        try {
