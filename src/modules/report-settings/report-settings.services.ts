...
export class ReportSettingsService {
    ...
    async addNewSettings(newSettings: ReportSettingsDto): Promise<ReportSettings> {
    ...
    async changeSetings(newSettings: ReportSettingsDto): Promise<ReportSettings> {
    ...
    async deleteSetings(settingIdentificator: DeleteReportSettingsDto): Promise<void> {
    ...
    async getSettings(settingIdentificator: GetSettingsDto): Promise<ReportSettings> {
    ...
    async getAllSettings(account: AccountDto): Promise<ReportSettings[]> {
