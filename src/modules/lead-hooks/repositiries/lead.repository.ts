...
import { AccountRecord } from '../core/account-record.entity';
...
export class LeadsRepository {
    ...
    async initNewAccount(accountId: number, subdomain: string, lead?: Types.ObjectId): Promise<AccountLeadsDocument> {
    ...
    async addOrUpdateLead(accountId: number, subdomain: string, lead: Lead): Promise<void> {
    ...
    async getLeadById(accountId: number, leadId: number): Promise<LeadDocument> {
    ...
    async deleteLeadById(accountId: number, leadId: number): Promise<void> {
    ...
    async getAllLeads(accountId: number): Promise<any> {
